...
import type { Company, User, Currency, Product, FinancialMetric, Promotion, Bundle, RevenueForecast, AiInsight, Event, Expense, Notification, InventoryLog, ChatbotLog, Sale } from "./types";
import {
  PRESET_COMPANIES,
...
import CompanySelection from "./components/layout/CompanySelection";
import Navbar from "./components/layout/Navbar";
import Sidebar from "./components/layout/Sidebar";

// Dashboards
import ExecutiveDashboard from "./components/layout/ExecutiveDashboard";
...
// Module views
import FinancialIntelligence from "./components/layout/FinancialIntelligence";
